...
app_ui <- function(request) {
  ...
  if (pagina == "despesas") {
    # Página limpa de despesas - sem cabeçalho, abas no topo
    fluidPage(
    ...
    # Página limpa de receitas - sem cabeçalho, abas no topo
    fluidPage(
    ...
    # Página inicial - estilo de índice de livro minimalista
    fluidPage(
