...
source(here("dados", "funcoes", "extrair_dados_arquivo_inadimplentes0.R"))
...
extrair_dados_pasta_inadimplentes <- 
  function(caminho_pasta_inadimplentes.c = here("dados", "cef", "inadimplentes")) {
      ...
      setdiff(
        ...
        c(
          ...
          list.files(
            ...
            full.names = T)[str_which(list.files(caminho_pasta_inadimplentes.c),
                                      "inadimplentes")]
        )
      )
    dados.pasta_l <- list()
    ...
    # Salvando num xlsx -------------------------------------------------------
      ...
      saveWorkbook(
        xlsx,
        paste0(here("dados", "cef", "inadimplentes", "formatados", nome.xlsx_c)),
        overwrite = T
      )
  }
